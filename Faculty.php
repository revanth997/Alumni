	...
	<div class="profilebody">
		...
		<div class="team-member">
			<ul>
				...
				<li>
					<img class="imgcircle" src="img/ranjith.png" alt=""/>
					<div class="clearfix"></div>
					<P><a href="SingleAlumni.php">Ranjith Kumar<br><label>Assistant Professor</label></a></P>
				</li>
				<li>
				...
				<li>
					<img class="imgcircle" src="img/anjaneyulu.png" alt=""/>
					<div class="clearfix">  </div>
					<P><a href="SingleAlumni.php">E Anjaneyulu<br><label>Assistant Professor</label></a></P>
				</li>
			</ul>		
		</div>	
