			...
			<ul>
				<li>
					...
					<div class="clearfix"></div>
					 <P><a href="Single_Alumni.php">Samit K Pradhan<br><label>Assistant Professor</label></a></P>
				</li>
				<li>
					<img class="imgcircle" src="img/venkatraman.jpg" alt=""/>
					<div class="clearfix">  </div>
					<P><a href="Single_Alumni.php">Venkat Raman B<br><label>Assistant Professor</label></a></P>
				</li>
				<li>
					<img class="imgcircle" src="img/sujoy.jpg" alt=""/>
					<div class="clearfix">  </div>
					<P><a href="Single_Alumni.php">Sujoy Sarkar<br><label>Assistant Professor</label></a></P>
				</li>
			</ul>		
		</div>	
